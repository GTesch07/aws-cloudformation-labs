...
### 1. Pré-requisitos
Certifique-se de ter o [AWS CLI](https://aws.amazon.com/cli/) instalado e configurado com suas credenciais.

### 2. Validar o Template
Antes de realizar o deploy, valide a sintaxe do arquivo:
```powershell
aws cloudformation validate-template --template-body file://seu-arquivo.json